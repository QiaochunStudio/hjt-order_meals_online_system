...
public class UserBuylook extends JFrame {
	...
	public UserBuylook(String username) {
		...
		try{
			...
			text.append("\t\t---- 菜  品 序 号 ----"+" 商  品  名  称 ----" + " 菜  品 价 格 ----"+" 购 买 数 量 ----" + " 菜  品 花 费 总 价 ----");
			while(res.next()){
	...
	class Myaction extends JFrame implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, "清 空 我 的 订 单 ！", "成功",JOptionPane.DEFAULT_OPTION);
		}
