...
public class IndexWelcome extends JFrame {
	...
	public IndexWelcome() {
		...
		button3.setText("3、查   看   最   新  菜   品");
		button3.setBackground(Color.WHITE);
		button3.setFont(new Font("微软雅黑",0,18));
		button3.setBorderPainted(false);
		
		button4.setText("4、查  看  我  购  买  的 餐 品");
		...
		button8.setText("7、配  送  地  址");
		button8.setBackground(Color.WHITE);
		button8.setFont(new Font("微软雅黑",0,18));
		button8.setBorderPainted(false);
		
		button7.setText("8、退  出  网  上  订  餐  系  统");
